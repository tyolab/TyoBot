...
import org.apache.nutch.urlfilter.index.RegexURLFilterIndex;
 ...
 */
public class TestRegexURLFilterIndex extends RegexURLFilterBaseTest {

  public TestRegexURLFilterIndex(String testName) {
    super(testName);
  }

  public static Test suite() {
    return new TestSuite(TestRegexURLFilterIndex.class);
  }
  ...
  protected URLFilter getURLFilter(Reader rules) {
    try {
      return new RegexURLFilterIndex(rules);
    } catch (IOException e) {
      fail(e.toString());
      return null;
    }
