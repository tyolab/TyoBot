 ...
 */
public class TestRegexURLFilterThumbnail extends RegexURLFilterBaseTest {

  public TestRegexURLFilterThumbnail(String testName) {
    super(testName);
  }

  public static Test suite() {
    return new TestSuite(TestRegexURLFilterThumbnail.class);
  }
  ...
  protected URLFilter getURLFilter(Reader rules) {
    try {
      return new RegexURLFilterThumbnail(rules);
    } catch (IOException e) {
      fail(e.toString());
      return null;
    }
